...
\newglossaryentry{over payment}{
	name={over payment},
	description={Over payment is the term used to represent invoice over payments, deposits, pre-payments, advances, etc. 
		Essentially any activity that results in paying too much or in advance. Over payments can apply
