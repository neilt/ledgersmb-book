...
can be maintained through the \menupath{General Journal \ma Chart of accounts \ma GIFI} and List GIFI menu items. Existing accounts can be edited by selecting them from the List GIFI menu, which opens a page where individual GIFI items can have their number or
